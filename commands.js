...
// 3. Query for all bounties, but exclude the client attribute from being show
db.collection.find({},{client:0})
// 4. Query for a Groundhog in the Woodlands
db.collection.find( {$and:[{location: "Woodlands"},{species: "Groundhog"}]})
// Update and Delete
...
// 2. Remove Lokinkajou
db.collection.deleteOne({name: "Lokinajou"})
// 3. Delete all bounties sent by Songbird
db.collection.deleteMany({client: "Songbird"}) 
